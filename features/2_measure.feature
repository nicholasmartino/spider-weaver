...
Feature: Spatial Metrics for City of Vancouver
  ...
  Scenario Outline: Aggregate from Data Source to Sample Along Street Network
    ...
    Examples:
      ...
      | statistics_canada/dissemination_area | Population, 2016                              | population          | sum       |
      | statistics_canada/dissemination_area | Population density per square kilometre, 2016 | population_density  | ave       |
